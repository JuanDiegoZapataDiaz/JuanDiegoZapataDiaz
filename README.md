# Juan Diego Zapata Diaz

Quantitative economist and M.Sc. candidate in Statistical Engineering. I build data pipelines, machine-learning models, and optimization tools for economic analysis and decision-making.

My work combines Python, statistical modeling, econometrics, operations research, and high-frequency data. I am currently part of the Price Department at the Central Reserve Bank of Peru, where I contribute to inflation monitoring, forecasting, and applied research.

## Contact

- Email: [juandiegohomd@gmail.com](mailto:juandiegohomd@gmail.com)
...
An end-to-end binary classification pipeline for credit approval prediction. It covers missing-value treatment, categorical encoding, feature scaling, cross-validation, model selection, and probability calibration. The project compares binomial GLMs with Random Forest and kernel SVM classifiers.

## Education

- M.Sc. candidate in Statistical Engineering, Universidad Nacional de Ingeniería (2026--2027)
- B.A. in Economics, Universidad del Pacífico (2020--2025)
